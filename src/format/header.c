...
/******************************************************************************
**                                                                           **
**  PRINT_LIST_HEADER: prints page header for the listing.                   **
**                                                                           **
******************************************************************************/

int print_list_header( char *filename, long pagenum, long total_lines,
...
#ifdef DIAGNOSTICS
     fprintf(stderr, "entering PRINT_LIST_HEADER\n");
#endif
...
#ifdef DIAGNOSTICS
     fprintf(stderr, "Exit PRINT_LIST_HEADER\n");
#endif
